...
class Broadcast extends React.Component<BroadcastProps, BroadcastState> {
    ...
    render() {
        let { title, thumbText, thumb, url, date } = this.props;
        ...
        return url ? (
            <div className="Broadcast">
                ...
                <div className="yt-video">
                    <a className="no-icon" href={url} target="_blank" rel="noreferrer">
                        ...
                        <div
                            className={`thumb jump-${this.state.videoGlitchId}`}
                            style={{ backgroundImage: `url(${thumbailImage})` }}
                        >
            ...
            <div className="Broadcast">
                ...
                <div className="yt-video">
                    <div
                        style={{ backgroundImage: `url(${thumbailImage})` }}
                        className={`thumb jump-${this.state.videoGlitchId} ${thumbailImage.length ? 'no-url' : ''}`}
                    >
                        {thumbText ? (
                            <span className="thumb-text">
                                <span>{thumbText}</span>
